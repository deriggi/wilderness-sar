...
the driver for this algorithm is the GeneticAgentMaker[https://github.com/deriggi/wilderness-sar/blob/master/src/main/java/genetic/GeneticAgentMaker.java]
