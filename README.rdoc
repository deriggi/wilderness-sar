...
=== Live Web App
The web app was used for watching agents move across the map. If you want to run a big simulation you should use the command line instead. I will keep this up for a couple weeks. At which point if it gets expensive I may put it on a smaller machine, or shut it down.
If it does go down and you want to play with it then contact me at john.deriggi at gmail
Live&nbsp;Web&nbsp;App[http://www.climateweb.co:8080/wisar/agentchooser/index.html]
