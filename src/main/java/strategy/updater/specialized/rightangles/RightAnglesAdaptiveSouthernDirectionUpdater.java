 ...
 * @author Johnny
 */
public class RightAnglesAdaptiveSouthernDirectionUpdater extends SkelatalDirectionUpdater {

    private static final Logger log = Logger.getLogger(RightAnglesAdaptiveSouthernDirectionUpdater.class.getName());
