 ...
 * @author Johnny
 */
public class RightAnglesAdaptiveWesternDirectionUpdater extends SkelatalDirectionUpdater {

    private static final Logger log = Logger.getLogger(RightAnglesAdaptiveWesternDirectionUpdater.class.getName());
